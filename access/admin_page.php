    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card bg-transparent" id="png">
          ...
          ?>
          <div class="card-body">
            <h1 class="text-center text-light">Welcome Aboard!</h1>
            ...
            <div class="d-grid gap-2 w-50 mx-auto">
              <a href="/BackEndStudy/access/admin_add.php" class="btn btn-primary">Add Data</a>
            ...
            <table id="tb-crud" width="100%">
              ...
              <?php
                ...
                if(isset($_GET['search'])) {
                  $word = $_GET['search'];
                  $query = "SELECT * FROM siswa WHERE nik LIKE '%$word%' OR jurusan LIKE '%$word%' OR nama LIKE '%$word%' ORDER BY id DESC";
                } else {
