  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <?php
      ...
      if(isset($_POST['submit'])) {
        ...
        if(empty($nik) || empty($nama) || empty($kelas) || empty($jurusan)){
          echo '
          ...
          if($filesize < 10044070) {
            ...
            $connect->query("UPDATE student SET nik = '$_nik', nama = '$_nama', photo = '$_photo', kelas = '$_kelas', jurusan = '$_jurusan' WHERE id = '$_id'");
    ...
    <table width="25%">
      ...
      <tr>
        <td>Kelas</td>
        <td>
          <select name="kelas" id="i-kelas">
            <option disabled>Kelas</option>
            <option <?php if($kelas == '10') { echo 'selected'; } ?> value="10">SMK Kelas 10</option>
            <option <?php if($kelas == '11') { echo 'selected'; } ?> value="11">SMK Kelas 11</option>
            <option <?php if($kelas == '12') { echo 'selected'; } ?> value="12">SMK Kelas 12</option>
          </select>
        </td>
      </tr>
      <tr>
